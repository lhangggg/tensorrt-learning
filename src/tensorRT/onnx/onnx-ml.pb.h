...
class AttributeProto final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::onnx::TypeProto* release_tp();
...
class TypeProto final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::onnx::TypeProto_Optional* release_optional_type();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::onnx::TypeProto_SparseTensor* release_sparse_tensor_type();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::onnx::TypeProto_Opaque* release_opaque_type();
