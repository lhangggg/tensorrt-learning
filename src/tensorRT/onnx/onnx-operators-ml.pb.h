...
class OperatorSetProto final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_magic();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_ir_version_prerelease();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_ir_build_metadata();
