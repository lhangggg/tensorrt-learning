...
typedef std::function<void(int current, int count, const std::vector<std::string> &files,
    ...
    Int8Process;
typedef std::function<std::vector<int64_t>(const std::string &name,
                                           const std::vector<int64_t> &shape)>
    LayerHookFuncReshape;
...
**/
bool compile(Mode mode, unsigned int maxBatchSize, const ModelSource &source,
             const CompileOutput &saveto, const std::vector<InputDims> inputsDimsSetup = {},
             Int8Process int8process = nullptr, const std::string &int8ImageDirectory = "",
