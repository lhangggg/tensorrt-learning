...
public:
    ...
    template <typename... _Args> int offset(int index, _Args... index_args) const
    {
    ...
    template <typename... _Args> Tensor &resize(int dim_size, _Args... dim_size_args)
    {
    ...
    template <typename DType, typename... _Args> inline DType *cpu(int i, _Args &&...args)
    {
    ...
    template <typename DType, typename... _Args> inline DType *gpu(int i, _Args &&...args)
    {
        return gpu<DType>() + offset(i, args...);
    }

    template <typename DType, typename... _Args> inline DType &at(int i, _Args &&...args)
    {
        return *(cpu<DType>() + offset(i, args...));
    }
    ...
    void reference_data(const std::vector<int> &shape, void *cpu_data, size_t cpu_size,
                        void *gpu_data, size_t gpu_size, DataType dtype);
